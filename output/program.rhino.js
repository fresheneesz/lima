...
var program = (function() {
    ...
    return lima.objectObj(scope1, [
        [lima.numberObj(0), lima.numberObj(1), false],
        [lima.numberObj(1), lima.numberObj(12345), false],
        [lima.numberObj(2), lima.numberObj(45), false],
        [lima.numberObj(3), lima.stringObj('hello'), false],
        [lima.numberObj(4), lima.stringObj('cat'), false],
        [lima.numberObj(5), (function() {
            var scope2 = {
                parent: scope1,
                variables: {}
            };
            return lima.objectObj(scope2, [
                [lima.numberObj(0), lima.numberObj(1), false],
                [lima.numberObj(1), lima.numberObj(2), false],
                [lima.numberObj(2), lima.numberObj(3), false]
            ])
        })(), false],
        [lima.numberObj(6), (function() {
            var scope3 = {
                parent: scope1,
                variables: {}
            };
            return lima.objectObj(scope3, [
                [lima.stringObj('moo'), lima.numberObj(5), false]
            ])
        })(), false],
        [lima.numberObj(7), (function() {
            var scope4 = {
                parent: scope1,
                variables: {}
            };
            return lima.objectObj(scope4, [
                [lima.stringObj('moo2'), lima.numberObj(5), true]
            ])
        })(), false],
        [lima.numberObj(8), (function() {
            var scope5 = {
                parent: scope1,
                variables: {}
            };
            return lima.objectObj(scope5, [
                [lima.stringObj('moo3'), lima.numberObj(5), false]
            ])
        })(), false],
        [lima.numberObj(9), (function() {
            var scope6 = {
                parent: scope1,
                variables: {}
            };
            return lima.objectObj(scope6, [
                [lima.stringObj('moo4'), lima.numberObj(5), true]
            ])
        })(), false],
        [lima.numberObj(10), lima.evalExpression([{
            v: lima.numberObj(2),
            n: lima.numberObj(2)
        }, '*', {
            v: lima.evalExpression([{
                v: lima.numberObj(3),
                n: lima.numberObj(3)
            }, '+', {
                v: lima.numberObj(4),
        ...
        [lima.numberObj(11), lima.evalExpression([{
            v: lima.numberObj(3),
            n: lima.numberObj(3)
        }, '*', {
            v: lima.numberObj(5),
        ...
        [lima.numberObj(12), (function() {
            var scope7 = {
                parent: scope1,
                variables: {}
            };
            return lima.objectObj(scope7, [
                [lima.numberObj(0), lima.numberObj(1), false],
                [lima.numberObj(1), lima.evalExpression([{
                    v: lima.numberObj(7),
                    n: lima.numberObj(7)
                }, '*', {
                    v: lima.numberObj(3),
                ...
                [lima.numberObj(2), lima.evalExpression([{
                    v: lima.numberObj(2),
                    n: lima.numberObj(2)
                }, '+', {
                    v: lima.numberObj(4),
                ...
                [lima.numberObj(3), lima.stringObj('cat'), false]
            ])
        })(), false],
        [lima.numberObj(13), (function() {
            var scope8 = {
                parent: scope1,
                variables: {}
            };
            return lima.objectObj(scope8, [
                [lima.stringObj('a'), lima.numberObj(1), true],
                [lima.stringObj('b'), lima.numberObj(2), true]
            ])
        })(), false],
        [lima.numberObj(14), lima.numberObj(2), false],
        [lima.numberObj(15), lima.evalExpression([{
            v: lima.numberObj(2),
            n: lima.numberObj(2)
        }, '+', {
            v: lima.numberObj(3),
        ...
        [lima.stringObj('a'), lima.numberObj(5), true],
        [lima.stringObj('b'), lima.stringObj('cat'), true],
        [lima.stringObj('c'), lima.numberObj(12), false],
        [lima.stringObj('test'), lima.fnObject(function() {
            var scope9 = {
                parent: scope1,
                variables: {}
            };
            scope9.variables['a'] = lima.nil();
            lima.evalExpression([{
                v: lima.variable(scope9, 'a'),
                n: lima.stringObj('a')
            }, '=', {
                v: (function() {
                    var scope10 = {
                    ...
                    return lima.objectObj(scope10, [
                        [lima.stringObj('x'), lima.stringObj('Nurse'), true]
                    ])
                })()
            }]);
            lima.evalBracketOperation(scope, {
                v: lima.variable(scope9, 'wout'),
                n: lima.stringObj('wout')
            }, '[', [{
                v: lima.evalExpression([{
                    v: lima.variable(scope9, 'a'),
                    n: lima.stringObj('a')
                }, '.', {
                    v: lima.variable(scope9, 'x'),
                    n: lima.stringObj('x')
                }])
            }])
        }), true],
        [lima.stringObj('main'), lima.fnObject(function() {
            var scope11 = {
                parent: scope1,
                variables: {}
            };
            lima.evalBracketOperation(scope, {
                v: lima.variable(scope11, 'wout'),
                n: lima.stringObj('wout')
            }, '[', [{
                v: lima.stringObj('Hellooooooo')
            }]);
            lima.evalBracketOperation(scope, {
                v: lima.variable(scope11, 'test'),
                n: lima.stringObj('test')
            }, '[', []);
            lima.evalBracketOperation(scope, {
                v: lima.variable(scope11, 'wout'),
                n: lima.stringObj('wout')
            }, '[', [{
                v: lima.variable(scope11, 'a'),
                n: lima.stringObj('a')
            }]);
            lima.evalBracketOperation(scope, {
                v: lima.variable(scope11, 'wout'),
